...
import NewHistorialMedico from "./NewHistorialMedico";
import NewMedicamento from "./NewMedicamento";
import NewVisita from "./NewVisita";

function PacienteInfoMedico(P) {
                ...
                data.visitas.map((H, index) => (
                  <div className="row" key={index}>
                    ...
                    <div className="col-11">
                      <div className="row">
                        <div className="col-4">
                        <p><strong>Fecha de visita:</strong> {format(new Date(H.fechaVisita), 'dd/MM/yyyy') || "N/A"}</p>
                        </div>
                        <div className="col-4">
                          <p><strong>Notas:</strong> {H.notas || "N/A"}</p>
                        </div>
...
export default PacienteInfoMedico
