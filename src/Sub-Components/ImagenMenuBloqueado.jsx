...
function ImagenMenuBloqueado(e) {
  return (
    <>
    <div className="imagenMenuBloqueada">
        <div className="image-container">
            <img src={Imagen} alt="" width={'100%'} />
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 516.375 516.375" xmlSpace="preserve">
                <g>
                    <g>
...
export default ImagenMenuBloqueado